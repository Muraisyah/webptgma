...
<table class="table table-striped"><thead><tr><th>#</th><th>Nama</th><th>Kota</th><th>Kategori</th><th>Aksi</th></tr></thead><tbody>
@foreach(App\Models\Hotel::paginate(15) as $h)
...
{{ App\Models\Hotel::paginate(15)->links() }}
</div></div>
@endsection
